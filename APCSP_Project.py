    ...
    while True:
        ...
        if already_has_a_plan == "yes":
            ...
            if another_plan == "yes":
                ...
                workout_plan_wanted = [workout.strip() for workout in type_of_workout_plan.split(",")]
                workout_plan = ""
                return f"Here is your workout plan: {workout_plan}"
            elif another_plan == "no":
                return "okay"
            else:
            ...
            if workout_plan == "yes":
                ...
                for workout in workout_plan_wanted:
                    if workout in workouts:
                        ...
                        workout_plan += f"\n{workout}: No plan found for this type"
                return f"This is your workout plan: {workout_plan}"
